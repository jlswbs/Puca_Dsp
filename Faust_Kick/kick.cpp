...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("att", &fHslider5, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("attf", &fHslider1, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("dec", &fHslider4, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.001f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("decf", &fHslider0, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("depth", &fHslider2, FAUSTFLOAT(12.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(24.0f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("freq", &fHslider3, FAUSTFLOAT(55.0f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow3 = int(4.8e+04f * fSlow2);
		float fSlow4 = float(iSlow0);
		float fSlow5 = float(fHslider2);
		float fSlow6 = 17.31234f * std::log(0.0022727272f * float(fHslider3));
		float fSlow7 = float(fHslider4);
		float fSlow8 = float(fHslider5);
		int iSlow9 = int(4.8e+04f * fSlow8);
		float fSlow10 = 0.5f * float(fHslider6);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec1[0] = 1;
			iVec2[0] = iSlow0;
			int iTemp0 = iSlow0 - iVec2[1];
			int iTemp1 = iTemp0 * (iTemp0 > 0);
			iRec3[0] = iSlow0 * (iRec3[1] + 1);
			int iTemp2 = (iRec3[0] < iSlow3) | iTemp1;
			...
			fRec2[0] = (1.0f - fTemp5) * ((iSlow0) ? ((iTemp2) ? fSlow4 : 0.0f) : 0.0f) + fTemp5 * fRec2[1];
			float fTemp6 = ((1 - iVec1[1]) ? 0.0f : fRec1[1] + 0.009166666f * std::pow(2.0f, 0.083333336f * (fSlow6 + fSlow5 * fRec2[0])));
			fRec1[0] = fTemp6 - std::floor(fTemp6);
			int iTemp7 = (iRec3[0] < iSlow9) | iTemp1;
			float fTemp8 = 0.1447178f * ((iSlow0) ? ((iTemp7) ? fSlow8 : fSlow7) : fSlow7);
			int iTemp9 = std::fabs(fTemp8) < 1.1920929e-07f;
			float fTemp10 = ((iTemp9) ? 0.0f : std::exp(0.0f - 2.0833333e-05f / ((iTemp9) ? 1.0f : fTemp8)));
			fRec4[0] = (1.0f - fTemp10) * ((iSlow0) ? ((iTemp7) ? fSlow4 : 0.0f) : 0.0f) + fTemp10 * fRec4[1];
			float fTemp11 = fSlow10 * fRec4[0] * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(256.0f * fRec1[0]), 255))];
...
kick::kick(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void kick::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float kick::getParamValue(const string& path)
{
