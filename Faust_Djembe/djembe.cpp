...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(1.3e+02f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(8e+02f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("gain", &fHslider3, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 0.0f - 1.9995203f * std::cos(0.00013089969f * fSlow0);
		...
		float fSlow20 = 0.0f - 1.9904289f * std::cos(0.00013089969f * (fSlow0 + 3.8e+03f));
		float fSlow21 = 0.0f - 1.9952087f * std::cos(0.00013089969f * (fSlow0 + 3.6e+03f));
		float fSlow22 = 0.0f - 1.9968045f * std::cos(0.00013089969f * (fSlow0 + 3.4e+03f));
		float fSlow23 = 0.0f - 1.9976029f * std::cos(0.00013089969f * (fSlow0 + 3.2e+03f));
		float fSlow24 = 0.0f - 1.998082f * std::cos(0.00013089969f * (fSlow0 + 3e+03f));
		float fSlow25 = 0.0f - 1.9984016f * std::cos(0.00013089969f * (fSlow0 + 2.8e+03f));
		float fSlow26 = 0.0f - 1.9986299f * std::cos(0.00013089969f * (fSlow0 + 2.6e+03f));
		float fSlow27 = 0.0f - 1.9988011f * std::cos(0.00013089969f * (fSlow0 + 2.4e+03f));
		float fSlow28 = 0.0f - 1.9989343f * std::cos(0.00013089969f * (fSlow0 + 2.2e+03f));
		float fSlow29 = 0.0f - 1.9990408f * std::cos(0.00013089969f * (fSlow0 + 2e+03f));
		float fSlow30 = 0.0f - 1.999128f * std::cos(0.00013089969f * (fSlow0 + 1.8e+03f));
		float fSlow31 = 0.0f - 1.9992007f * std::cos(0.00013089969f * (fSlow0 + 1.6e+03f));
		float fSlow32 = 0.0f - 1.9992621f * std::cos(0.00013089969f * (fSlow0 + 1.4e+03f));
		float fSlow33 = 0.0f - 1.9993148f * std::cos(0.00013089969f * (fSlow0 + 1.2e+03f));
		float fSlow34 = 0.0f - 1.9993604f * std::cos(0.00013089969f * (fSlow0 + 1e+03f));
		float fSlow35 = 0.0f - 1.9994005f * std::cos(0.00013089969f * (fSlow0 + 8e+02f));
		float fSlow36 = 0.0f - 1.9994357f * std::cos(0.00013089969f * (fSlow0 + 6e+02f));
		float fSlow37 = 0.0f - 1.999467f * std::cos(0.00013089969f * (fSlow0 + 4e+02f));
		float fSlow38 = 0.0f - 1.9994951f * std::cos(0.00013089969f * (fSlow0 + 2e+02f));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec5[0] = fTemp1 - (fSlow20 * fRec5[1] + 0.99045175f * fRec5[2]);
			fRec6[0] = fTemp1 - (fSlow21 * fRec6[1] + 0.99521446f * fRec6[2]);
			fRec7[0] = fTemp1 - (fSlow22 * fRec7[1] + 0.9968071f * fRec7[2]);
			fRec8[0] = fTemp1 - (fSlow23 * fRec8[1] + 0.99760437f * fRec8[2]);
			fRec9[0] = fTemp1 - (fSlow24 * fRec9[1] + 0.998083f * fRec9[2]);
			fRec10[0] = fTemp1 - (fSlow25 * fRec10[1] + 0.99840224f * fRec10[2]);
			fRec11[0] = fTemp1 - (fSlow26 * fRec11[1] + 0.99863034f * fRec11[2]);
			fRec12[0] = fTemp1 - (fSlow27 * fRec12[1] + 0.99880147f * fRec12[2]);
			fRec13[0] = fTemp1 - (fSlow28 * fRec13[1] + 0.99893457f * fRec13[2]);
			fRec14[0] = fTemp1 - (fSlow29 * fRec14[1] + 0.999041f * fRec14[2]);
			fRec15[0] = fTemp1 - (fSlow30 * fRec15[1] + 0.99912816f * fRec15[2]);
			fRec16[0] = fTemp1 - (fSlow31 * fRec16[1] + 0.9992008f * fRec16[2]);
			fRec17[0] = fTemp1 - (fSlow32 * fRec17[1] + 0.9992623f * fRec17[2]);
			fRec18[0] = fTemp1 - (fSlow33 * fRec18[1] + 0.99931496f * fRec18[2]);
			fRec19[0] = fTemp1 - (fSlow34 * fRec19[1] + 0.9993606f * fRec19[2]);
			fRec20[0] = fTemp1 - (fSlow35 * fRec20[1] + 0.99940056f * fRec20[2]);
			fRec21[0] = fTemp1 - (fSlow36 * fRec21[1] + 0.9994358f * fRec21[2]);
			fRec22[0] = fTemp1 - (fSlow37 * fRec22[1] + 0.99946713f * fRec22[2]);
			fRec23[0] = fTemp1 - (fSlow38 * fRec23[1] + 0.99949515f * fRec23[2]);
			float fTemp2 = 0.05f * (fRec0[0] + 0.25f * (fRec23[0] - fRec23[2]) + 0.11111111f * (fRec22[0] - fRec22[2]) + 0.0625f * (fRec21[0] - fRec21[2]) + 0.04f * (fRec20[0] - fRec20[2]) + 0.027777778f * (fRec19[0] - fRec19[2]) + 0.020408163f * (fRec18[0] - fRec18[2]) + 0.015625f * (fRec17[0] - fRec17[2]) + 0.012345679f * (fRec16[0] - fRec16[2]) + 0.01f * (fRec15[0] - fRec15[2]) + 0.008264462f * (fRec14[0] - fRec14[2]) + 0.0069444445f * (fRec13[0] - fRec13[2]) + 0.00591716f * (fRec12[0] - fRec12[2]) + 0.0051020407f * (fRec11[0] - fRec11[2]) + 0.0044444446f * (fRec10[0] - fRec10[2]) + 0.00390625f * (fRec9[0] - fRec9[2]) + 0.0034602077f * (fRec8[0] - fRec8[2]) + 0.0030864198f * (fRec7[0] - fRec7[2]) + 0.002770083f * (fRec6[0] - fRec6[2]) + 0.0025f * (fRec5[0] - fRec5[2]) - fRec0[2]);
...
void djembe::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float djembe::getParamValue(const string& path)
{
...
extern "C" void app_main()
{
    ...
    djembe* DSP = new djembe(48000, 32);
    DSP->start();
