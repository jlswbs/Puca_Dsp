...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("damp", &fHslider0, FAUSTFLOAT(0.01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("freq", &fHslider1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 70.588234f * (float(fHslider1) + -0.05f);
		float fSlow2 = fSlow1 + -1.499995f;
		int iSlow3 = int(fSlow2);
		int iSlow4 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow3 + 4)))) + 1;
		...
		float fSlow10 = 0.041666668f * fSlow9 * fSlow6;
		int iSlow11 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow3 + 3)))) + 1;
		float fSlow12 = fSlow1 + (-4.0f - fSlow5);
		float fSlow13 = 0.16666667f * fSlow9 * (0.0f - fSlow12);
		int iSlow14 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow3 + 2)))) + 1;
		float fSlow15 = 0.5f * fSlow8 * (0.0f - fSlow6) * (0.0f - 0.5f * fSlow12);
		int iSlow16 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow3 + 1)))) + 1;
		float fSlow17 = (0.0f - fSlow7) * (0.0f - 0.5f * fSlow6) * (0.0f - 0.33333334f * fSlow12);
		float fSlow18 = fSlow1 - fSlow5;
		int iSlow19 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow3)))) + 1;
		float fSlow20 = (0.0f - fSlow8) * (0.0f - 0.5f * fSlow7) * (0.0f - 0.33333334f * fSlow6) * (0.0f - 0.25f * fSlow12);
		float fSlow21 = float(fButton0);
		float fSlow22 = float(fHslider2);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = fSlow0 * (fRec1[1] + fRec1[2]);
			fRec7[IOTA0 & 255] = fTemp0;
			float fRec8 = fSlow20 * fRec7[(IOTA0 - iSlow19) & 255] + fSlow18 * (fSlow17 * fRec7[(IOTA0 - iSlow16) & 255] + fSlow15 * fRec7[(IOTA0 - iSlow14) & 255] + fSlow13 * fRec7[(IOTA0 - iSlow11) & 255] + fSlow10 * fRec7[(IOTA0 - iSlow4) & 255]);
			fVec0[0] = fSlow21;
			float fTemp1 = fSlow21 - fVec0[1];
			float fTemp2 = fSlow22 * fTemp1 * float(fTemp1 > 0.0f);
			float fTemp3 = fRec0[2] + fTemp2;
			fVec1[IOTA0 & 255] = fTemp3;
			float fTemp4 = fSlow18 * (fSlow17 * fVec1[(IOTA0 - iSlow16) & 255] + fSlow15 * fVec1[(IOTA0 - iSlow14) & 255] + fSlow13 * fVec1[(IOTA0 - iSlow11) & 255] + fSlow10 * fVec1[(IOTA0 - iSlow4) & 255]);
			float fTemp5 = fSlow20 * fVec1[(IOTA0 - iSlow19) & 255];
			float fRec9 = fTemp5 + fTemp4;
			float fRec10 = fTemp4 + fTemp0 + fTemp5;
			fRec3[0] = fRec8;
			float fRec4 = fTemp2 + fRec3[1];
			float fRec5 = fRec9;
			float fRec6 = fRec10;
			fRec0[0] = fRec4;
			fRec1[0] = fRec5;
...
void karplus::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float karplus::getParamValue(const string& path)
{
