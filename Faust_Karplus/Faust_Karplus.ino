// PÚCA_DSP - Faust dsp karplus-strong //
...
karplus* DSP = new karplus(SAMPLE_RATE, NO_SAMPLES);

float freq, damp, gain, gate;
...
void loop() {
  ...
  damp = randomf(0.001f, 0.02f);
  freq = randomf(0.3f, 1.8f);
  gate = 1.0f;
