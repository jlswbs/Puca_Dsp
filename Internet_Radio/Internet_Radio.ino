// PÚCA_DSP - Internet radio stream //
...
String ssid =     "xxxxxx";   // WiFi Network settings, enter your SSID and Password here
...
void setup() {
    ...
    wm8978.hpVolSet(25,25);  // headphones volume, range 0-63
    ...
    audio.setChannels(2); 
    audio.setVolume(21);  // range 0-21

    audio.connecttohost("http://worldwidefm.out.airtime.pro:8000/worldwidefm_a");
