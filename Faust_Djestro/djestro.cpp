...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "djestro.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("djestro");
		ui_interface->addHorizontalSlider("damp", &fHslider4, FAUSTFLOAT(0.01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("gain", &fHslider3, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addButton("gate", &fButton0);
		ui_interface->addHorizontalSlider("posit", &fHslider2, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("sharp", &fHslider1, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 0.0f - 1.9995203f * std::cos(0.5235988f * fSlow0);
		float fSlow2 = float(fButton0);
		float fSlow3 = 1.0f / std::max<float>(1.0f, 96.0f * float(fHslider1));
		float fSlow4 = float(fHslider2);
		float fSlow5 = std::tan(6.544984e-05f * (1.5e+04f * fSlow4 + 5e+02f));
		...
		float fSlow11 = std::tan(6.544984e-05f * (5e+02f * fSlow4 + 4e+01f));
		...
		float fSlow16 = (fSlow15 + -1.4142135f) / fSlow11 + 1.0f;
		float fSlow17 = 1.0f / ((fSlow15 + 1.4142135f) / fSlow11 + 1.0f);
		float fSlow18 = 0.0f - 2.0f / fSlow12;
		float fSlow19 = float(fHslider3);
		float fSlow20 = fSlow19 / fSlow9;
		float fSlow21 = 4e+03f * fSlow0;
		float fSlow22 = 0.0f - 1.9904289f * std::cos(0.00013089969f * (fSlow21 + 3.8e+03f));
		float fSlow23 = 0.0f - 1.9952087f * std::cos(0.00013089969f * (fSlow21 + 3.6e+03f));
		float fSlow24 = 0.0f - 1.9968045f * std::cos(0.00013089969f * (fSlow21 + 3.4e+03f));
		float fSlow25 = 0.0f - 1.9976029f * std::cos(0.00013089969f * (fSlow21 + 3.2e+03f));
		float fSlow26 = 0.0f - 1.998082f * std::cos(0.00013089969f * (fSlow21 + 3e+03f));
		float fSlow27 = 0.0f - 1.9984016f * std::cos(0.00013089969f * (fSlow21 + 2.8e+03f));
		float fSlow28 = 0.0f - 1.9986299f * std::cos(0.00013089969f * (fSlow21 + 2.6e+03f));
		float fSlow29 = 0.0f - 1.9988011f * std::cos(0.00013089969f * (fSlow21 + 2.4e+03f));
		float fSlow30 = 0.0f - 1.9989343f * std::cos(0.00013089969f * (fSlow21 + 2.2e+03f));
		float fSlow31 = 0.0f - 1.9990408f * std::cos(0.00013089969f * (fSlow21 + 2e+03f));
		float fSlow32 = 0.0f - 1.999128f * std::cos(0.00013089969f * (fSlow21 + 1.8e+03f));
		float fSlow33 = 0.0f - 1.9992007f * std::cos(0.00013089969f * (fSlow21 + 1.6e+03f));
		float fSlow34 = 0.0f - 1.9992621f * std::cos(0.00013089969f * (fSlow21 + 1.4e+03f));
		float fSlow35 = 0.0f - 1.9993148f * std::cos(0.00013089969f * (fSlow21 + 1.2e+03f));
		float fSlow36 = 0.0f - 1.9993604f * std::cos(0.00013089969f * (fSlow21 + 1e+03f));
		float fSlow37 = 0.0f - 1.9994005f * std::cos(0.00013089969f * (fSlow21 + 8e+02f));
		float fSlow38 = 0.0f - 1.9994357f * std::cos(0.00013089969f * (fSlow21 + 6e+02f));
		float fSlow39 = 0.0f - 1.999467f * std::cos(0.00013089969f * (fSlow21 + 4e+02f));
		float fSlow40 = 0.0f - 1.9994951f * std::cos(0.00013089969f * (fSlow21 + 2e+02f));
		float fSlow41 = 0.5f * (0.2f * (1.0f - float(fHslider4)) + 0.8f);
		float fSlow42 = 70.588234f * (fSlow0 + -0.05f);
		float fSlow43 = fSlow42 + -1.499995f;
		int iSlow44 = int(fSlow43);
		int iSlow45 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow44 + 4)))) + 1;
		float fSlow46 = std::floor(fSlow43);
		float fSlow47 = fSlow42 + (-3.0f - fSlow46);
		float fSlow48 = fSlow42 + (-2.0f - fSlow46);
		float fSlow49 = fSlow42 + (-1.0f - fSlow46);
		float fSlow50 = fSlow49 * fSlow48;
		float fSlow51 = 0.041666668f * fSlow50 * fSlow47;
		int iSlow52 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow44 + 3)))) + 1;
		float fSlow53 = fSlow42 + (-4.0f - fSlow46);
		float fSlow54 = 0.16666667f * fSlow50 * (0.0f - fSlow53);
		int iSlow55 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow44 + 2)))) + 1;
		float fSlow56 = 0.5f * fSlow49 * (0.0f - fSlow47) * (0.0f - 0.5f * fSlow53);
		int iSlow57 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow44 + 1)))) + 1;
		float fSlow58 = (0.0f - fSlow48) * (0.0f - 0.5f * fSlow47) * (0.0f - 0.33333334f * fSlow53);
		float fSlow59 = fSlow42 - fSlow46;
		int iSlow60 = int(std::min<float>(423.52942f, float(std::max<int>(0, iSlow44)))) + 1;
		float fSlow61 = (0.0f - fSlow49) * (0.0f - 0.5f * fSlow48) * (0.0f - 0.33333334f * fSlow47) * (0.0f - 0.25f * fSlow53);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec3[0] = 4.656613e-10f * float(iRec4[0]) - fSlow17 * (fSlow16 * fRec3[2] + fSlow14 * fRec3[1]);
			fRec2[0] = fSlow17 * (fSlow13 * fRec3[0] + fSlow18 * fRec3[1] + fSlow13 * fRec3[2]) - fSlow10 * (fSlow8 * fRec2[2] + fSlow6 * fRec2[1]);
			float fTemp1 = fSlow20 * (fRec2[2] + fRec2[0] + 2.0f * fRec2[1]) * std::max<float>(0.0f, std::min<float>(fTemp0, 2.0f - fTemp0));
			fRec0[0] = fTemp1 - (fSlow1 * fRec0[1] + 0.9995204f * fRec0[2]);
			fRec5[0] = fTemp1 - (fSlow22 * fRec5[1] + 0.99045175f * fRec5[2]);
			fRec6[0] = fTemp1 - (fSlow23 * fRec6[1] + 0.99521446f * fRec6[2]);
			fRec7[0] = fTemp1 - (fSlow24 * fRec7[1] + 0.9968071f * fRec7[2]);
			fRec8[0] = fTemp1 - (fSlow25 * fRec8[1] + 0.99760437f * fRec8[2]);
			fRec9[0] = fTemp1 - (fSlow26 * fRec9[1] + 0.998083f * fRec9[2]);
			fRec10[0] = fTemp1 - (fSlow27 * fRec10[1] + 0.99840224f * fRec10[2]);
			fRec11[0] = fTemp1 - (fSlow28 * fRec11[1] + 0.99863034f * fRec11[2]);
			fRec12[0] = fTemp1 - (fSlow29 * fRec12[1] + 0.99880147f * fRec12[2]);
			fRec13[0] = fTemp1 - (fSlow30 * fRec13[1] + 0.99893457f * fRec13[2]);
			fRec14[0] = fTemp1 - (fSlow31 * fRec14[1] + 0.999041f * fRec14[2]);
			fRec15[0] = fTemp1 - (fSlow32 * fRec15[1] + 0.99912816f * fRec15[2]);
			fRec16[0] = fTemp1 - (fSlow33 * fRec16[1] + 0.9992008f * fRec16[2]);
			fRec17[0] = fTemp1 - (fSlow34 * fRec17[1] + 0.9992623f * fRec17[2]);
			fRec18[0] = fTemp1 - (fSlow35 * fRec18[1] + 0.99931496f * fRec18[2]);
			fRec19[0] = fTemp1 - (fSlow36 * fRec19[1] + 0.9993606f * fRec19[2]);
			fRec20[0] = fTemp1 - (fSlow37 * fRec20[1] + 0.99940056f * fRec20[2]);
			fRec21[0] = fTemp1 - (fSlow38 * fRec21[1] + 0.9994358f * fRec21[2]);
			fRec22[0] = fTemp1 - (fSlow39 * fRec22[1] + 0.99946713f * fRec22[2]);
			fRec23[0] = fTemp1 - (fSlow40 * fRec23[1] + 0.99949515f * fRec23[2]);
			float fTemp2 = fSlow41 * (fRec25[1] + fRec25[2]);
			fRec31[IOTA0 & 127] = fTemp2;
			float fRec32 = fSlow61 * fRec31[(IOTA0 - iSlow60) & 127] + fSlow59 * (fSlow58 * fRec31[(IOTA0 - iSlow57) & 127] + fSlow56 * fRec31[(IOTA0 - iSlow55) & 127] + fSlow54 * fRec31[(IOTA0 - iSlow52) & 127] + fSlow51 * fRec31[(IOTA0 - iSlow45) & 127]);
			float fTemp3 = fSlow2 - fVec0[1];
			float fTemp4 = fSlow19 * fTemp3 * float(fTemp3 > 0.0f);
			float fTemp5 = fRec24[2] + fTemp4;
			fVec1[IOTA0 & 127] = fTemp5;
			float fTemp6 = fSlow59 * (fSlow58 * fVec1[(IOTA0 - iSlow57) & 127] + fSlow56 * fVec1[(IOTA0 - iSlow55) & 127] + fSlow54 * fVec1[(IOTA0 - iSlow52) & 127] + fSlow51 * fVec1[(IOTA0 - iSlow45) & 127]);
			float fTemp7 = fSlow61 * fVec1[(IOTA0 - iSlow60) & 127];
			float fRec33 = fTemp7 + fTemp6;
			float fRec34 = fTemp6 + fTemp2 + fTemp7;
			fRec27[0] = fRec32;
			float fRec28 = fTemp4 + fRec27[1];
			float fRec29 = fRec33;
			float fRec30 = fRec34;
			fRec24[0] = fRec28;
			fRec25[0] = fRec29;
			float fRec26 = fRec30;
			float fTemp8 = 0.5f * fRec26 + 0.025f * (fRec0[0] + 0.25f * (fRec23[0] - fRec23[2]) + 0.11111111f * (fRec22[0] - fRec22[2]) + 0.0625f * (fRec21[0] - fRec21[2]) + 0.04f * (fRec20[0] - fRec20[2]) + 0.027777778f * (fRec19[0] - fRec19[2]) + 0.020408163f * (fRec18[0] - fRec18[2]) + 0.015625f * (fRec17[0] - fRec17[2]) + 0.012345679f * (fRec16[0] - fRec16[2]) + 0.01f * (fRec15[0] - fRec15[2]) + 0.008264462f * (fRec14[0] - fRec14[2]) + 0.0069444445f * (fRec13[0] - fRec13[2]) + 0.00591716f * (fRec12[0] - fRec12[2]) + 0.0051020407f * (fRec11[0] - fRec11[2]) + 0.0044444446f * (fRec10[0] - fRec10[2]) + 0.00390625f * (fRec9[0] - fRec9[2]) + 0.0034602077f * (fRec8[0] - fRec8[2]) + 0.0030864198f * (fRec7[0] - fRec7[2]) + 0.002770083f * (fRec6[0] - fRec6[2]) + 0.0025f * (fRec5[0] - fRec5[2]) - fRec0[2]);
...
djestro::djestro(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void djestro::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float djestro::getParamValue(const string& path)
{
...
extern "C" void app_main()
{
    ...
    djestro* DSP = new djestro(48000, 32);
    DSP->start();
