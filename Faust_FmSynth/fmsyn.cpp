  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec0[0] = 1;
			iRec0[0] = (iVec0[1] + iRec0[1]) % 256;
			table[i1] = std::sin(0.024543693f * float(iRec0[0]));
			iVec0[1] = iVec0[0];
			iRec0[1] = iRec0[0];
		}
	}
...
static float ftbl0mydspSIG0[257];
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("description", "simple 2op fm synth");
	...
	static void classInit(int sample_rate) {
		...
		sig0->fillmydspSIG0(257, ftbl0mydspSIG0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fmsyn");
		ui_interface->addHorizontalSlider("enva", &fHslider4, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("envd", &fHslider5, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("envr", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("envs", &fHslider6, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("feed", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("freq", &fHslider1, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(4e+03f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("gain", &fHslider8, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addButton("gate", &fButton0);
		ui_interface->addHorizontalSlider("lfo", &fHslider7, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("shape", &fHslider2, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = 0.00091875f * float(fHslider0);
		float fSlow1 = float(fHslider1);
		float fSlow2 = fSlow1 + -1.0f;
		float fSlow3 = 0.00091875f * float(fHslider2);
		int iSlow4 = float(fButton0) > 0.0f;
		float fSlow5 = float(fHslider3);
		float fSlow6 = float(fHslider4);
		int iSlow7 = int(4.8e+04f * fSlow6);
		float fSlow8 = float(fHslider5);
		float fSlow9 = float(iSlow4);
		float fSlow10 = float(fHslider6) * fSlow9;
		float fSlow11 = 1e+03f * (float(fHslider7) + 1.0f);
		float fSlow12 = 0.5f * float(fHslider8);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec1[0] = 1;
			int iTemp0 = 1 - iVec1[1];
			fRec4[0] = fSlow0 + 0.99908125f * fRec4[1];
			fRec5[0] = fSlow3 + 0.99908125f * fRec5[1];
			float fTemp1 = ((iTemp0) ? 0.0f : fRec3[1] + 2.0833333e-05f * (fSlow1 * fRec5[0] + fSlow2 * fRec4[0] * fRec2[1]));
			fRec3[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = 256.0f * fRec3[0];
			int iTemp3 = int(fTemp2);
			float fTemp4 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp3, 256))];
			fRec2[0] = fTemp4 + (fTemp2 - std::floor(fTemp2)) * (ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp3 + 1, 256))] - fTemp4);
			iVec2[0] = iSlow4;
			int iTemp5 = iSlow4 - iVec2[1];
			iRec7[0] = iSlow4 * (iRec7[1] + 1);
			int iTemp6 = (iRec7[0] < iSlow7) | (iTemp5 * (iTemp5 > 0));
			float fTemp7 = 0.1447178f * ((iSlow4) ? ((iTemp6) ? fSlow6 : fSlow8) : fSlow5);
			int iTemp8 = std::fabs(fTemp7) < 1.1920929e-07f;
			float fTemp9 = ((iTemp8) ? 0.0f : std::exp(-(2.0833333e-05f / ((iTemp8) ? 1.0f : fTemp7))));
			fRec6[0] = (1.0f - fTemp9) * ((iSlow4) ? ((iTemp6) ? fSlow9 : fSlow10) : 0.0f) + fTemp9 * fRec6[1];
			float fTemp10 = ((iTemp0) ? 0.0f : fRec1[1] + 2.0833333e-05f * (fSlow1 + fSlow11 * fRec6[0] * fRec2[0]));
			fRec1[0] = fTemp10 - std::floor(fTemp10);
			float fTemp11 = 256.0f * fRec1[0];
			int iTemp12 = int(fTemp11);
			float fTemp13 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp12, 256))];
			float fTemp14 = fSlow12 * fRec6[0] * (fTemp13 + (fTemp11 - std::floor(fTemp11)) * (ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp12 + 1, 256))] - fTemp13));
...
fmsyn::fmsyn(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void fmsyn::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float fmsyn::getParamValue(const string& path)
{
