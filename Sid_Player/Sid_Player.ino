...
static unsigned short out_buf[DMA_BUF_LEN * 2];
...
static void audio_task(void *userData) {
  ...
  while(1) {
    ...
    libcsid_render(out_buf, DMA_BUF_LEN);
...
void setup() {
  ...
  libcsid_load((unsigned char *)&music_goa_sid, music_goa_sid_len, 0);
